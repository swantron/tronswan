...
describe('FizzBuzz Component', () => {
  test('renders page title', () => {
    ...
    expect(screen.getByTestId('fizzbuzz-page-title')).toHaveTextContent(
      'trontronbuzztron'
    );
  });
  ...
  test('renders subtitle', () => {
    render(<FizzBuzz />);
    expect(
      screen.getByText('🤖 robot-powered FizzBuzz sequence generator')
    ).toBeInTheDocument();
  });
  ...
  test('renders input section', () => {
    render(<FizzBuzz />);
    expect(
      screen.getByLabelText('Enter a number for FizzBuzz')
    ).toBeInTheDocument();
    expect(
      screen.getByPlaceholderText('Enter a number (e.g., 100)')
    ).toBeInTheDocument();
    expect(
      screen.getByText('Enter a number to generate FizzBuzz sequence:')
    ).toBeInTheDocument();
  });
  ...
  test('renders FizzBuzz rules', () => {
    ...
    expect(
      screen.getByText('Numbers divisible by 3 → "Fizz"')
    ).toBeInTheDocument();
    expect(
      screen.getByText('Numbers divisible by 5 → "Buzz"')
    ).toBeInTheDocument();
    expect(
      screen.getByText('Numbers divisible by both 3 and 5 → "FizzBuzz"')
    ).toBeInTheDocument();
    expect(
      screen.getByText('All other numbers → the number itself')
    ).toBeInTheDocument();
  });
  ...
  test('renders info section', () => {
    render(<FizzBuzz />);
    expect(
      screen.getByText(/FizzBuzz is a classic programming exercise/)
    ).toBeInTheDocument();
  });
  ...
  test('FizzBuzzDisplay component renders correctly', () => {
    ...
    expect(screen.getByText('FizzBuzz')).toBeInTheDocument();
    expect(
      screen.getByText(/1, 2, Fizz, 4, Buzz, Fizz, 7, 8, Fizz, Buzz/)
    ).toBeInTheDocument();
  });
